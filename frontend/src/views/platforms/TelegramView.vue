      ...
      <template v-if="tab === 'bot'">
        <section class="card card-pad">
          ...
          <ul class="what">
            ...
            <li>
              <b>Статусы заказов.</b> Бот предлагает покупателю кнопку «Получать статусы заказов»: поделившись номером,
              он начинает получать обновления по своим заказам прямо в Telegram.
              <span v-if="data.telegram.subscribers">Сейчас так подписаны: {{ data.telegram.subscribers }}.</span>
              <span v-else class="faint">Пока никто не подписан.</span>
            </li>
          </ul>
